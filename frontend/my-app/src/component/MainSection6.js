...
import stetoscopeImg from './styles/src_regainimages/doctorman.png';
    ...
    <div className="main-section-6" >
      <div className="left-svg">
        <div className="svg-layer-1">
          ...
          <path fill="#729762" d="M27.6,-50C39.2,-41.2,54.2,-40.6,66.7,-33.6C79.2,-26.6,89.2,-13.3,83.4,-3.3C77.7,6.7,56.3,13.4,47.6,26.9C38.8,40.4,42.7,60.6,36.9,72C31.1,83.4,15.5,86.1,2,82.7C-11.6,79.3,-23.3,69.9,-31.2,59.7C-39,49.4,-43.2,38.4,-44.7,28.3C-46.2,18.2,-45.1,9.1,-41.2,2.3C-37.3,-4.6,-30.6,-9.2,-28.3,-17.9C-26,-26.7,-28.2,-39.6,-24.2,-52.8C-20.2,-66,-10.1,-79.3,-1,-77.6C8,-75.8,16.1,-58.8,27.6,-50Z" transform="translate(100 100)" />
          </svg>
        </div>
